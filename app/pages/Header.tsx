        ...
        <header className="rounded-lg shadow dark:bg-gray-900 m-4">
            <nav className="flex items-center justify-between p-4">
                ...
                <ul className="flex space-x-4">
                    <li>
                        <h1 className="text-gray-300 font-bold text-xl sm:hidden hover:text-white pt-2"><Link href="/Prizing">Pricing</Link></h1>
                    </li>
                    <li>
                        <h1 className="text-gray-300 font-bold text-xl sm:hidden hover:text-white  pt-2"><Link href="/Signup">Sign Up</Link></h1>
                    </li>
                    <li>
                        <h1 className="bg-white p-2 rounded-md text-black font-bold cursor-pointer text-xl hover:bg-gray-300"><Link href="/Signup">Sign Up</Link></h1>
                    </li>
                </ul>
            </nav>
        </header>
